...
<a href="https://github.com/metcalfc/changelog-generator/releases/tag/v4.6.1"><img alt="Example Release Notes" src="./release-notes.png" width="400"></a>
...
- name: Generate changelog
  id: changelog
  uses: metcalfc/changelog-generator@v4.6.1
  with:
...
- name: Generate changelog
  id: changelog
  uses: metcalfc/changelog-generator@v4.6.1 #TODO: bump this after release
  with:
    myToken: ${{ secrets.GITHUB_TOKEN }}
