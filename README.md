...
<a href="https://github.com/metcalfc/changelog-generator/releases/tag/v4.9.1"><img alt="Example Release Notes" src="./release-notes.png" width="400"></a>
...
- name: Generate changelog
  id: changelog
  uses: metcalfc/changelog-generator@v4.9.1
  with:
...
# Immutable SHA (safe)
uses: metcalfc/changelog-generator@3f82cef08fe5dcf57c591fe165e70e1d5032e15a # v4.9.1
```
